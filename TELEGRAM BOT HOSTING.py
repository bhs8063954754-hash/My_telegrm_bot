...
# --- Configuration ---
TOKEN = '8576751016:AAF0MmUQ3VpDaSlAWJ-e3tQLHt7_ux7PpsY' # Replace with your actual token
OWNER_ID = 8253251013 # Replace with your Owner ID
ADMIN_ID = 8253251013 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@bhawanisinghrajput' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'https://t.me/zihuu_pvp' # Replace with your update channel link
...
# File upload limits
FREE_USER_LIMIT = 30
SUBSCRIBED_USER_LIMIT = 1500 # Changed from 10 to 15
...
def _logic_send_welcome(message):
    ...
    welcome_msg_text = (f"〽️ Welcome, {user_name}!\n\n🆔 Your User ID: `{user_id}`\n"
                        ...
                        f"📁 Files Uploaded: {current_files} / (200)"
